                                                ...
                                                <td>
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                                            <a class="dropdown-item" href="<?= base_url('app/lihat_materi/') . '/' . encrypt_url($m->id_materi) . '/' . encrypt_url(session()->get('id')); ?>">Lihat</a>
                                                            ...
                                                            <a class="dropdown-item btn-hapus" href="<?= base_url('app/hapus_materi/') . '/' . encrypt_url($m->kode_materi) . '/' . encrypt_url(session()->get('id')); ?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
<div class="modal fade" id="tambah_materi" tabindex="-1" role="dialog" aria-labelledby="tambah_materiLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url('app/tambah_materi'); ?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="edit_materi" tabindex="-1" role="dialog" aria-labelledby="edit_materiLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url('app/edit_materi_'); ?>" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
