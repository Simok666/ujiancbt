                                                ...
                                                <td>
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                                            ...
                                                            <?php endif; ?>
                                                            <a class="dropdown-item btn-unpublish" href="<?= base_url('guru/publish_ujian/') . '/' . encrypt_url($u->kode_ujian) . '/' . encrypt_url(session()->get('id')); ?>"><?= ($u->publish == 1) ? 'Unpublish' : 'Publish' ?></a>
